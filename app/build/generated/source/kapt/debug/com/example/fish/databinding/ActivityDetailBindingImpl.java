...
public class ActivityDetailBindingImpl extends ActivityDetailBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.example.fish.ui.detail.DetailViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.example.fish.ui.detail.DetailViewModel ViewModel) {
