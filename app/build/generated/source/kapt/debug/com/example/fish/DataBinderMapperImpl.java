...
import com.example.fish.databinding.ModifyPersonalInformationBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_MODIFYPERSONALINFORMATION = 21;
  ...
  static {
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.example.fish.R.layout.modify_personal_information, LAYOUT_MODIFYPERSONALINFORMATION);
  }
  ...
  public ViewDataBinding getDataBinder(DataBindingComponent component, View view, int layoutId) {
    ...
    if(localizedLayoutId > 0) {
      ...
      switch(localizedLayoutId) {
        ...
        case  LAYOUT_MODIFYPERSONALINFORMATION: {
          if ("layout/modify_personal_information_0".equals(tag)) {
            return new ModifyPersonalInformationBindingImpl(component, view);
          }
          throw new IllegalArgumentException("The tag for modify_personal_information is invalid. Received: " + tag);
        }
      }
    }
    return null;
  ...
  private static class InnerLayoutIdLookup {
    ...
    static {
      ...
      sKeys.put("layout/modify_personal_information_0", com.example.fish.R.layout.modify_personal_information);
    }
  }
}
