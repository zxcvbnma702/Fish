package com.example.base.ui.bar;

/**
 * @author:SunShibo
 * @date:2022-08-19 20:44
 * @feature:
 */
...
public class BottomNavigationBar extends LinearLayout implements View.OnClickListener {
    ...
    //选中时icon
    private int[] selectIcon = {R.drawable.home_on, R.drawable.chat_on, R.drawable.shop_on, R.drawable.my_on};
    private String[] titles = {"主页","消息","购物车","我的"};

    public void setNormalIcon(int[] normalIcon) {
        this.normalIcon = normalIcon;
    }

    private int[] normalIcon = {R.drawable.home_off, R.drawable.chat_off, R.drawable.shop_off, R.drawable.my_off};
